...
func (tr *AppServiceCertificateBinding) GetObservation() (map[string]any, error) {
...
func (tr *AppServiceCertificateBinding) SetObservation(obs map[string]any) error {
...
func (tr *AppServiceCertificateBinding) GetParameters() (map[string]any, error) {
...
func (tr *AppServiceCertificateBinding) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AppServiceCertificateBinding
func (tr *AppServiceCertificateBinding) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AppServiceCertificateBinding
func (tr *AppServiceCertificateBinding) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
