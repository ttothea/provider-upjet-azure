...
type AIFoundryEncryptionInitParameters struct {

	// The Key Vault URI to access the encryption key.
	KeyID *string `json:"keyId,omitempty" tf:"key_id,omitempty"`

	// The Key Vault ID where the customer owned encryption key exists.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/cluster/keyvault/v1beta2.Vault
...
type AIFoundryEncryptionObservation struct {
...
type AIFoundryEncryptionParameters struct {
...
type AIFoundryIdentityInitParameters struct {
...
type AIFoundryIdentityObservation struct {
...
type AIFoundryIdentityParameters struct {
...
type AIFoundryInitParameters struct {
	...
	Encryption *AIFoundryEncryptionInitParameters `json:"encryption,omitempty" tf:"encryption,omitempty"`
	...
	Identity *AIFoundryIdentityInitParameters `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	ManagedNetwork *AIFoundryManagedNetworkInitParameters `json:"managedNetwork,omitempty" tf:"managed_network,omitempty"`
...
type AIFoundryManagedNetworkInitParameters struct {
...
type AIFoundryManagedNetworkObservation struct {

	// The isolation mode of the AI Foundry Hub. Possible values are Disabled, AllowOnlyApprovedOutbound, and AllowInternetOutbound.
	IsolationMode *string `json:"isolationMode,omitempty" tf:"isolation_mode,omitempty"`
}

type AIFoundryManagedNetworkParameters struct {
...
type AIFoundryObservation struct {
	...
	// An encryption block as defined below. Changing this forces a new AI Foundry Hub to be created.
	Encryption *AIFoundryEncryptionObservation `json:"encryption,omitempty" tf:"encryption,omitempty"`
	...
	// A identity block as defined below.
	Identity *AIFoundryIdentityObservation `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	// A managed_network block as defined below.
	ManagedNetwork *AIFoundryManagedNetworkObservation `json:"managedNetwork,omitempty" tf:"managed_network,omitempty"`
...
type AIFoundryParameters struct {
	...
	// An encryption block as defined below. Changing this forces a new AI Foundry Hub to be created.
	// +kubebuilder:validation:Optional
	Encryption *AIFoundryEncryptionParameters `json:"encryption,omitempty" tf:"encryption,omitempty"`
	...
	// A identity block as defined below.
	// +kubebuilder:validation:Optional
	Identity *AIFoundryIdentityParameters `json:"identity,omitempty" tf:"identity,omitempty"`
	...
	// A managed_network block as defined below.
	// +kubebuilder:validation:Optional
	ManagedNetwork *AIFoundryManagedNetworkParameters `json:"managedNetwork,omitempty" tf:"managed_network,omitempty"`
...
// AIFoundry is the Schema for the AIFoundrys API. Manages a Microsoft Foundry Hub (classic) resource.
