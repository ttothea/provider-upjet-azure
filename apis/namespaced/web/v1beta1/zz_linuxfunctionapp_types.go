...
type LinuxFunctionAppAuthSettingsV2InitParameters struct {
...
type LinuxFunctionAppAuthSettingsV2Observation struct {
...
type LinuxFunctionAppAuthSettingsV2Parameters struct {
...
type LinuxFunctionAppInitParameters struct {
	...
	AuthSettingsV2 *LinuxFunctionAppAuthSettingsV2InitParameters `json:"authSettingsV2,omitempty" tf:"auth_settings_v2,omitempty"`
	...
	// The ID of the App Service Plan within which to create this Function App
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/web/v1beta1.ServicePlan
	...
	StickySettings *LinuxFunctionAppStickySettingsInitParameters `json:"stickySettings,omitempty" tf:"sticky_settings,omitempty"`
...
type LinuxFunctionAppObservation struct {
	...
	// An auth_settings_v2 block as defined below.
	AuthSettingsV2 *LinuxFunctionAppAuthSettingsV2Observation `json:"authSettingsV2,omitempty" tf:"auth_settings_v2,omitempty"`
	...
	// A sticky_settings block as defined below.
	StickySettings *LinuxFunctionAppStickySettingsObservation `json:"stickySettings,omitempty" tf:"sticky_settings,omitempty"`
...
type LinuxFunctionAppParameters struct {
	...
	// An auth_settings_v2 block as defined below.
	// +kubebuilder:validation:Optional
	AuthSettingsV2 *LinuxFunctionAppAuthSettingsV2Parameters `json:"authSettingsV2,omitempty" tf:"auth_settings_v2,omitempty"`
	...
	// A sticky_settings block as defined below.
	// +kubebuilder:validation:Optional
	StickySettings *LinuxFunctionAppStickySettingsParameters `json:"stickySettings,omitempty" tf:"sticky_settings,omitempty"`
...
type LinuxFunctionAppSiteConfigIPRestrictionHeadersInitParameters struct {
...
type LinuxFunctionAppSiteConfigIPRestrictionHeadersObservation struct {
...
type LinuxFunctionAppSiteConfigIPRestrictionHeadersParameters struct {
...
type LinuxFunctionAppSiteConfigIPRestrictionInitParameters struct {
	...
	Headers *LinuxFunctionAppSiteConfigIPRestrictionHeadersInitParameters `json:"headers,omitempty" tf:"headers,omitempty"`
...
type LinuxFunctionAppSiteConfigIPRestrictionObservation struct {
	...
	// A headers block as defined above.
	Headers *LinuxFunctionAppSiteConfigIPRestrictionHeadersObservation `json:"headers,omitempty" tf:"headers,omitempty"`
...
type LinuxFunctionAppSiteConfigIPRestrictionParameters struct {
	...
	// A headers block as defined above.
	// +kubebuilder:validation:Optional
	Headers *LinuxFunctionAppSiteConfigIPRestrictionHeadersParameters `json:"headers,omitempty" tf:"headers,omitempty"`
...
type LinuxFunctionAppStickySettingsInitParameters struct {
...
type LinuxFunctionAppStickySettingsObservation struct {
...
type LinuxFunctionAppStickySettingsParameters struct {
