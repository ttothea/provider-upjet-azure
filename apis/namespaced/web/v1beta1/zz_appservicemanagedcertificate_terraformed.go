...
func (tr *AppServiceManagedCertificate) GetObservation() (map[string]any, error) {
...
func (tr *AppServiceManagedCertificate) SetObservation(obs map[string]any) error {
...
func (tr *AppServiceManagedCertificate) GetParameters() (map[string]any, error) {
...
func (tr *AppServiceManagedCertificate) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AppServiceManagedCertificate
func (tr *AppServiceManagedCertificate) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AppServiceManagedCertificate
func (tr *AppServiceManagedCertificate) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
