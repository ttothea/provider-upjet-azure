...
func (mg *AppActiveSlot) ResolveReferences( // ResolveReferences of this AppActiveSlot.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "WindowsWebAppSlot", "WindowsWebAppSlotList")
		if err != nil {
...
func (mg *AppHybridConnection) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("relay.azure.m.upbound.io", "v1beta1", "HybridConnection", "HybridConnectionList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "WindowsWebApp", "WindowsWebAppList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *AppServiceCertificateBinding) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "AppServiceManagedCertificate", "AppServiceManagedCertificateList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "AppServiceCustomHostNameBinding", "AppServiceCustomHostNameBindingList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *FunctionApp) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "AppServicePlan", "AppServicePlanList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *FunctionAppActiveSlot) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "WindowsFunctionAppSlot", "WindowsFunctionAppSlotList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *FunctionAppFunction) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "LinuxFunctionApp", "LinuxFunctionAppList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *FunctionAppHybridConnection) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "WindowsFunctionApp", "WindowsFunctionAppList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *FunctionAppSlot) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.AppServicePlanIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "FunctionApp", "FunctionAppList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *LinuxWebAppSlot) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("web.azure.m.upbound.io", "v1beta1", "LinuxWebApp", "LinuxWebAppList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
