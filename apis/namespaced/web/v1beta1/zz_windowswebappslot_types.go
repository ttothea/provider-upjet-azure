...
type WindowsWebAppSlotLogsHTTPLogsAzureBlobStorageInitParameters struct {
	...
	// SAS url to an Azure blob container with read/write/list/delete permissions.
	SASURLSecretRef v1.LocalSecretKeySelector `json:"sasurlSecretRef" tf:"-"`
}
...
type WindowsWebAppSlotParameters struct {
	...
	// The ID of the Windows Web App this Deployment Slot will be part of. Changing this forces a new Windows Web App to be created.
	// +crossplane:generate:reference:type=github.com/upbound/provider-azure/v2/apis/namespaced/web/v1beta1.WindowsWebApp
	...
	// +kubebuilder:validation:Optional
	AppServiceIDRef *v1.NamespacedReference `json:"appServiceIdRef,omitempty" tf:"-"`

	// Selector for a WindowsWebApp in web to populate appServiceId.
	// +kubebuilder:validation:Optional
	AppServiceIDSelector *v1.NamespacedSelector `json:"appServiceIdSelector,omitempty" tf:"-"`
...
type WindowsWebAppSlotSiteConfigApplicationStackInitParameters struct {
	...
	DockerRegistryPasswordSecretRef *v1.LocalSecretKeySelector `json:"dockerRegistryPasswordSecretRef,omitempty" tf:"-"`
