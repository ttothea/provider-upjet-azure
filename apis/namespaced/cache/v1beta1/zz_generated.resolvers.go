...
func (mg *ManagedRedisAccessPolicyAssignment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("cache.azure.m.upbound.io", "v1beta1", "ManagedRedis", "ManagedRedisList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RedisEnterpriseDatabase) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("cache.azure.m.upbound.io", "v1beta1", "RedisEnterpriseCluster", "RedisEnterpriseClusterList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
