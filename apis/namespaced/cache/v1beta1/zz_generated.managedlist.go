...
// GetItems of this ManagedRedisAccessPolicyAssignmentList.
func (l *ManagedRedisAccessPolicyAssignmentList) GetItems() []resource.Managed {
...
// GetItems of this ManagedRedisList.
func (l *ManagedRedisList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
