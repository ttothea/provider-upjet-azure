...
// SetupWebhookWithManager_servicenetworking registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_servicenetworking(mgr ctrl.Manager) error {
