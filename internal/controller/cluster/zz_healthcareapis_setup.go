...
// SetupWebhookWithManager_healthcareapis registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_healthcareapis(mgr ctrl.Manager) error {
