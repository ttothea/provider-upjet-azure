...
// SetupWebhookWithManager_operationsmanagement registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_operationsmanagement(mgr ctrl.Manager) error {
