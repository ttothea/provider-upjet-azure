...
// SetupWebhookWithManager_policyinsights registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_policyinsights(mgr ctrl.Manager) error {
