...
// SetupWebhookWithManager_dbformysql registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_dbformysql(mgr ctrl.Manager) error {
