...
import (
	...
	v1beta2 "github.com/upbound/provider-azure/v2/apis/cluster/iotcentral/v1beta2"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta2.Application_GroupVersionKind)))
