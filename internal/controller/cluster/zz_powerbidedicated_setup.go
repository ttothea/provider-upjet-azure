...
// SetupWebhookWithManager_powerbidedicated registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_powerbidedicated(mgr ctrl.Manager) error {
