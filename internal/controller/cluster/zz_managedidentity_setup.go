...
// SetupWebhookWithManager_managedidentity registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_managedidentity(mgr ctrl.Manager) error {
