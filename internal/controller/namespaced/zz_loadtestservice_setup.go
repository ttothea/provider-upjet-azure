...
// SetupWebhookWithManager_loadtestservice registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_loadtestservice(mgr ctrl.Manager) error {
