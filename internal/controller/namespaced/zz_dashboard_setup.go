...
// SetupWebhookWithManager_dashboard registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_dashboard(mgr ctrl.Manager) error {
