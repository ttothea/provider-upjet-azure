...
// SetupWebhookWithManager registers the conversion webhook for MonitorScheduledQueryRulesAlert.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.MonitorScheduledQueryRulesAlert{}).
		Complete(); err != nil {
...
// SetupGated adds a controller that reconciles MonitorScheduledQueryRulesAlert managed resources.
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1beta1.MonitorScheduledQueryRulesAlert_GroupVersionKind.String())
		}
	}, v1beta1.MonitorScheduledQueryRulesAlert_GroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.MonitorScheduledQueryRulesAlert_GroupVersionKind)))
