...
// SetupWebhookWithManager registers the conversion webhook for LinkedCustomService.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.LinkedCustomService{}).
		Complete(); err != nil {
...
// SetupGated adds a controller that reconciles LinkedCustomService managed resources.
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.LinkedCustomService_GroupVersionKind)))
