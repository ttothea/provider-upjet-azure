...
// SetupWebhookWithManager_customproviders registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_customproviders(mgr ctrl.Manager) error {
