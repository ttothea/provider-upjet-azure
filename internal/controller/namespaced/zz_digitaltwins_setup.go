...
// SetupWebhookWithManager_digitaltwins registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_digitaltwins(mgr ctrl.Manager) error {
