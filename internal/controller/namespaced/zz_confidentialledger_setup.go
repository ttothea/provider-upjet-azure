...
// SetupWebhookWithManager_confidentialledger registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_confidentialledger(mgr ctrl.Manager) error {
