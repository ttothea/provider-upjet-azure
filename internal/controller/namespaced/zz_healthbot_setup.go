...
// SetupWebhookWithManager_healthbot registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_healthbot(mgr ctrl.Manager) error {
